...
import { Menu, Sticky, Dropdown, Image, Button, Sidebar, Icon, Dimmer, Label, Grid } from "semantic-ui-react";
import User from "../../models/User";
import ResponsiveDesktop from "../../website/components/shared/ResponsiveDesktop";
import ResponsiveMobile from "../../website/components/shared/ResponsiveMobile";
import { WRAPPER_VIEW_STYLE } from "../../shared/styles";
import { FormattedMessage } from "react-intl";
import MenuFab from "../../website/components/shared/MenuFab";
...
class NavBar extends React.Component<Props, States> {
    ...
    private renderMenuForDesktop = (): React.ReactElement<any> => {
        return <Fragment>
            ...
            <Menu.Item as={NavLink} to="/admin/dashboard/home" >
                <FormattedMessage id="page.admin.dashboard.home"/>
            </Menu.Item>
            <Menu.Item as={NavLink} to="/admin/dashboard/student" >
                <FormattedMessage id="page.admin.dashboard.student"/>
            </Menu.Item>
            <Menu.Item as={NavLink} to="/admin/dashboard/teacher" >
                <FormattedMessage id="page.admin.dashboard.teacher"/>
            </Menu.Item>
            <Menu.Item as="a" href="http://localhost:3000/admin">
                <FormattedMessage id="page.admin"/>
            </Menu.Item>
    ...
    private renderMenuForMobile = (): React.ReactElement<any> => {
        return <Sidebar as={Menu} width="thin" vertical
            ...
            style={{zIndex: 9999}} >
            <Menu.Item as={NavLink} exact to="/admin/dashboard" onClick={this.hideSideBar}>
                <Icon name="home" />
                <FormattedMessage id="page.admin.dashboard.home"/>
            </Menu.Item>
            <Menu.Item as={NavLink} to="/admin/dashboard/student" onClick={this.hideSideBar}>
                <Icon name="building" />
                <FormattedMessage id="page.admin.dashboard.student"/>
            </Menu.Item>
            <Menu.Item as={NavLink} to="/admin/dashboard/teacher" onClick={this.hideSideBar}>
...
export default connectAllProps(NavBar);